...
I also encourage you to check other projects too, with the same philosophy like [Basscss](https://basscss.com/), [Tachyons](http://tachyons.io/) or [Tailwind CSS](https://tailwindcss.com/).
...
<table class="border--1 border-style--solid border-collapse--collapse text-align--center" style="margin: 0 auto">
  <caption class="font-weight--bold padding--8">CSS Processing speed comparison</caption>
  <thead>
    <tr>
      <th class="padding--8 border--0 border-bottom-width--1 border-right-width--1 border-style--solid">Compiled Marca.com</th>
      <th class="padding--8 border--0 border-bottom-width--1 border-right-width--1 border-style--solid">Compiled UCSS</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td class="padding--8 border-right-width--1 border-right-style--solid">84,3ms</td>
      <td class="padding--8">8,4ms</td>
    </tr>
  </tbody>
</table>
